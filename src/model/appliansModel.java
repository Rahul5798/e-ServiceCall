...
import model.appliansBean;
import db.dbConnection;

public class appliansModel {

	public List<appliansBean> getData(String s){
		List<appliansBean> list=new ArrayList<appliansBean>();
		try
		{
			...
			while(rs.next())
			{
				appliansBean se=new appliansBean();
	...
	public void deletePlumb(int id) {
