...
import model.PlumbBean;
import db.dbConnection;

public class PlumbModel {

	public List<PlumbBean> getData(String s){
		List<PlumbBean> list=new ArrayList<PlumbBean>();
		try
		{
