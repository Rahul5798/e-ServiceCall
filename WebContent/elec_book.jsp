...
<%
	...
	List<serviceBean> list=s.getServices("electrician");
%>

<div class="container">
	<ol class="breadcrumb">
		<li><a href="index1.jsp">Home</a></li>
		<li class="active">Electrical Service booking</li>
	</ol>
	<div class="row">
		<form name="frm" method="post" action="http://localhost:8080/EServiceCal/book_elec">
			<div class="col-md-6">
