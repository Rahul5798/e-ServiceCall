<%@ page import="model.appliansModel"%>
...
<%@ page import="model.appliansBean"%>
...
<div class="container">
		...
		<div>
			<h3 style="color: #337ab7;">#Appliances Services</h3>
			<div class="row">
...
<%
   		appliansModel dao=new appliansModel();
   		List<appliansBean> list=dao.getData("s01");
%>
				<tr>

					<%
	for(appliansBean obj:list)
	{
%>
					<td><%=obj.getId()%></td>
					<td><%=obj.getBookId()%></td>
					...
					<a class="btn btn-primary btn-sm"
						href="fwd_applians.jsp?uid=<%=obj.getId()%>&id=<%=obj.getBookId()%>&se_name=<%=obj.getSe_name()%>&date=<%=obj.getDate()%>&time=<%=obj.getTime()%>&city=<%=obj.getCity()%>&area=<%=obj.getArea()%>&address=<%=obj.getAddress()%>">
...
<div class="container">
		...
		<div>
			<h3 style="color: #337ab7;">#Forwarded to Worker Appliances Services</h3>
			<div class="row">
...
<%
   		...
   		List<fwdWorkerBean> lst=fm.getallData("s04");
%>
				<tr>
...
<div class="container">
		...
		<div>
			<h3 style="color: #337ab7;">#Completed Appliances Services</h3>
			<div class="row">
...
<%
   		...
   		List<completedBean> lst1=cm.getallData("s04");
%>
				<tr>
