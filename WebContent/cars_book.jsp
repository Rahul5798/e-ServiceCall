...
<%
	...
	List<serviceBean> list=s.getServices("carpenter");
%>

<div class="container">
	<ol class="breadcrumb">
		<li><a href="index1.jsp">Home</a></li>
		<li class="active">Carpenter Service booking</li>
	</ol>
	<div class="row">
		<form name="frm" method="post" action="http://localhost:8080/EServiceCal/book_car">
			<div class="col-md-6">
