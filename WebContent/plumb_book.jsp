...
<%
	...
	List<serviceBean> list=s.getServices("plumbing");
%>

<div class="container">
	<ol class="breadcrumb">
		<li><a href="index.jsp">Home</a></li>
		<li class="active">Plumbing Service booking</li>
	</ol>
	<div class="row">
		<form name="frm" method="post" action="http://localhost:8080/EServiceCal/book_plumb">
			<div class="col-md-6">
